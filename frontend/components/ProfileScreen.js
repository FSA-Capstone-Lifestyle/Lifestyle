  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userInfoSection}>
        ...
        <Text style={{marginTop:25,borderWidth:1,borderRadius:30,paddingHorizontal:12,paddingVertical:4,borderColor:'gray',fontSize:14,fontWeight:'bold',color:'#383735'}}>Edit Profile</Text>
        </TouchableOpacity>
        </View>
      </View>
      <View style={styles.userInfoSection}>
      ...
      <View style={styles.menuWrapper}>
        <TouchableRipple onPress={() => {}}>
          ...
          <ImageBackground style={{width:350,height:200}} source={require('../../assets/workout.jpg')} resizeMode='cover'>
          <View style={{position: 'absolute', top: 15, left: 15, right: 0, bottom: 0}}>
          <Text style={{fontSize:25,color:'white'}}>{'My Workout\nPlan'}</Text>
          </View>
          </ImageBackground>
        ...
        <TouchableRipple  onPress={() => {}}>
          <View style={styles.menuItem}>
          <ImageBackground style={{width:350,height:200}} source={require('../../assets/meal.jpg')} resizeMode='cover'>
          <View style={{position: 'absolute', top: 15, left: 15, right: 0, bottom: 0}}>
            <Text style={{fontSize:25,color:'white'}}>{'My Diet\nPlan'}</Text>
          </View>
          </ImageBackground>
          </View>
        </TouchableRipple>
